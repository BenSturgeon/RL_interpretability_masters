...
\label{sec:interp_techniques}
    ...
    \subsubsection{Steering effects per individual channels}
    ...
    The method involves placing a specific entity into an artificially generated environment using a maze with the shape visible in figure\ref{fig:intervention-experiment}. This design was chosen because it was challenging enough that the agent would need to retain its navigational abilities to reach either the entity or target intervention zone, while providing a clear decision point where the agent needs to choose between pursuing the original entity or our artificial target zone.
