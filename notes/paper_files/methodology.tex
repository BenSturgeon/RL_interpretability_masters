...
\subsection{Feature Visualization}
    ...
    RQs 1, 2 and 4 aimed to tackle how the network determines which entity to target next, as there are many instances where multiple routes lead to different entities and the sequence of collection is critical to success. This experiment addresses these questions by isolating how the network encodes different goal entities and determining whether the model uses entity-specific channels or a general targeting mechanism.
