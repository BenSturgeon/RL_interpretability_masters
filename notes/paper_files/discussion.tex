...
We were surprised by the extreme degree of redundancy of steering that could be found in this network, whereby modifying a single channel in a single layer was sufficient to completely alter behaviour. We hypothesise that a reason for this is due to the network being strongly biased towards targeting via negative activations rather than positive activations. Evidence of this is provided in the mean activations generally being slightly below 0 for channels during a standard rollout, as seen in Figure~\ref{fig:activation_tracking_all}. 
