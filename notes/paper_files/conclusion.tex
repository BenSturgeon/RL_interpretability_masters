...
The two-phase processing architecture, with convolutional layers determining the structure of the maze and positions of entities while fully-connected layers determine `how to get there', matches what we might expect from such a network and provides tangible evidence of theoretical predictions. This architecture offers opportunities for targeted debugging and potential pathways to achieving precise and simple control of such models.

Looking forward, activation-level encoding may extend beyond this specific environment and architecture. The conditions that encourage the development of these structures: repeated use of similar circuitry for structurally similar subtasks that require clear delineation, appear across many domains. If activation magnitude proves to be a general mechanism for information multiplexing under efficiency constraints, it could have implications for how we build, interpret, and control neural networks. The simplicity and low cost of applying these techniques makes them particularly appealing. More work is required to verify this phenomenon across other models, and to determine how different types of models and domains change the way in which it might manifest.

Given this potential, we hope that understanding this particular toy model may alter the way the reader thinks about neural networks, and that cracking the problem of the inner workings of such models may be easier as a result. 
