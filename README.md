...
1. **Shared-channel encoding.** The network does not dedicate channels to specific targets. Channels are reused across entities, with activation *magnitude* encoding which target is currently active.
